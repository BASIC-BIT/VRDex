...
describe("account feature access", () => {
  it("honors expiry and lets super-admin imply seed lookup", () => {
    ...
    assert.deepEqual(
      ...
      { superAdmin: true, canReviewMedia:false, canViewPrivateSeedLookup: true, canUseTemporalParsing: true },
    );
    assert.deepEqual(
      accountFeatureAccessFromGrants(
      ...
      { superAdmin: false, canReviewMedia:false, canViewPrivateSeedLookup: false, canUseTemporalParsing: false },
    );
    assert.deepEqual(
      accountFeatureAccessFromGrants(
      ...
      { superAdmin: false, canReviewMedia:false, canViewPrivateSeedLookup: false, canUseTemporalParsing: true },
    );
  });
});
