...
Community-submitted public profiles now start at `/submit`. Person, community,
and world pages render at `/<slug>`. Community event pages render at
`/<community>/events/<event-code>`.
