...
The delete confirmation submits the role's `updatedAt` from when it opened. If another tab changes the role, deletion fails before revoking assignments or changing visibility.
