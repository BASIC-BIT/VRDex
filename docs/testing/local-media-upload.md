...
The local upload bridge is disabled by default. Task 3 adds the transport and accounting boundaries. It does not enable hosted intake or raise legacy contribution limits.
