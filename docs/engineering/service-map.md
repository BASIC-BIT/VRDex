...
| AWS SES | Domain email verification and future transactional email. Retired for auth email, which Clerk sends. | [SES auth email](../deployment/ses-auth-email.md), [AWS service baseline](../deployment/aws-baseline.md) |
