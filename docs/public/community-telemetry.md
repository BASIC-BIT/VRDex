...
Population observations, instance history, coverage, member-count changes, and rollups are retained permanently. Creating summaries does not remove the detailed observations. Disconnecting stops collection without deleting retained history. Deletion workflows are deferred.
