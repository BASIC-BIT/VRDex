...
export function validClaimAnalyticsJourneyId(value: string | undefined): value is string {
...
export function claimAnalyticsContext(
  ...
  const validJourneyId = validClaimAnalyticsJourneyId(journeyId) ? journeyId : undefined;
