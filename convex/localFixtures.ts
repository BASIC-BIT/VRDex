...
async function ensureProfile(
  ...
  const shared = {
    ...
    // Optional fields are assigned unconditionally so a fixture revision that
    // drops one clears the stored value: db.patch removes fields set to undefined.
    searchAliases: fixture.searchAliases,
    tags: fixture.tags,
