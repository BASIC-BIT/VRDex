 ...
 *
 * Everything under here is the old `/events/new` entry point or shared editor
 * implementation. Public and edit routes live below their community slug. The
 * editor renders private VRCDN output
