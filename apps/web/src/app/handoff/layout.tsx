...
/**
 * Blocks `/handoff` from session replay.
 *
 * Replay records every route and is kept safe by masking, but `maskAllInputs`
 * covers input *values* only — not rendered text or `<option>` labels. A handoff page is reached with a bearer token and shows the prepared profile before anyone owns it.
 *
